...
export const createInvoiceStyles = {
  ...
  // Cards/Sections
cardContainer:"bg-white/80 backdrop-blur-xl rounded-2xl p-3 sm:p-4 md:p-4 border border-gray-200/60 shadow-sm w-full",
...
cardIconContainer:"p-1.5 rounded-lg w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 flex items-center justify-center",
...
export const appShellStyles = {
  ...
  sidebarContainer: "px-6 py-8 h-full flex flex-col relative z-10",
...
export const kpiCardStyles = {
  ...
  // Icon
iconContainer:
"w-8 h-8 bg-purple-600 text-white rounded-lg flex items-center justify-center flex-shrink-0",

icon:
"w-10 h-19 text-white",
