...
const AiInvoiceModal = ({open, onClose, onGenerate, initialText = " "}) => {
    ...
    async function handleGenerateClick () {
        ...
        const raw = (text || "").trim();
    if(!raw) {
        setError("Please paste invoice text to genertae from AI.");
        return;
    }
        ...
        <div className={aiInvoiceModalStyles.overlay}>
            ...
            <div className={aiInvoiceModalStyles.modal}>
                <div className=" flex items-start justify-between">
                    <div>
                        ...
                        <p className={aiInvoiceModalStyles.description}>
                            Paste any text that contains invoice details (clientInformation, items, qty,
                ...
                <div className= " mt-4">
                    ...
                    placeholder={`eg. A person wants a logo design...`}
                    rows={8}
