...
<section className={heroStyles.section}>
    <div className={heroStyles.bgElement}></div>
    <div className={heroStyles.bgElement}></div>
    <div className={heroStyles.bgElement}></div>
    ...
    <div className={heroStyles.container}>
        <div className={heroStyles.grid}>
            ...
            <div className={heroStyles.demoColumn}>
                <div className={heroStyles.demoFloating}></div>
                <div className={heroStyles.demoFloating}></div>

                <div className = {heroStyles.demoContainer}>
                    <div className={heroStyles.demoCaed}>
                            ...
                            <div className=" space-y-1">
                                <div className={heroStyles.cardLogoContainer}>
                                    ...
                                    <div>
                                        ...
                                        <div className={heroStyles.cardClientGet}>
                                            GST: 27AAAPL1234C1ZV
                                        </div>
                                    </div>
                                </div>
